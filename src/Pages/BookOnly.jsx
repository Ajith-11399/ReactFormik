    ...
    <div>
      ...
      <div className="container-fluid mt-3">
        ...
        <div className="card mb-4">
          <div className="card-header">Books Data</div>
                ...
                >
                  <thead>
                    <tr className="text-center">
                      ...
                      <th scope="col" className="text-center">Book's Title</th>
                      <th scope="col" className="text-center">Author</th>
                      <th scope="col" className="text-center">Published Date</th>
                      <th scope="col" className="text-center">ISBN Number</th>
